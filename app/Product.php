...
{
    protected $fillable = [
        'package_buy_id', 'brand_id', 'category_id','unit_id', 'lot_gallary_id', 'acc_cus_sup_id','product_name', 'product_model', 'product_image','batch_no', 'serial_no','supplier_price','our_price','status',
    ];
    protected $casts = [
